...
/** @type {Promise<{ lat: number, lon: number, zip: string | null, place: string | null, stateAbbrev: string | null, stateName: string | null }> | null} */
 ...
 * @returns {Promise<{ lat: number, lon: number, zip: string | null, place: string | null, stateAbbrev: string | null, stateName: string | null }>}
 */
