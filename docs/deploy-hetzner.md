...
| Trusted LAN, no auth | **Use basic auth** |

Most panels (weather, calendar, sky/earth events, radar) work unchanged — they call public APIs from the server.
...
3. Local copies of gitignored files you care about: `.env`, `public/data/bookmarks-personal.json`, `public/data/notes.md`, `data/*`.
