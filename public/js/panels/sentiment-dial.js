...
export function createSentimentDialBlock() {
  ...
  head.textContent = 'Fear & Greed Index';
  head.title = 'CNN Business Fear & Greed Index (opens in new tab)';
  ...
  const dial = createIndicatorDial(dialMount, { ariaLabel: 'Fear and Greed index dial' });
